...
public class Player : MonoBehaviour
{
    ...
    {
        Vector2 originLeft = new Vector2(pos.x - 0.5f + 0.2f, pos.y - 1.5f);
        Vector2 originMiddle = new Vector2(pos.x, pos.y - 1.5f);
        Vector2 originRight = new Vector2(pos.x + 0.5f - 0.2f, pos.y - 1.5f);
